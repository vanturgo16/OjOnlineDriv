...
public class DetailActiveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data = AktifFragment.data.get(posisi);

        requestFrom.setText("From : " +data.getBookingFrom());

        requestTakeBooking.setText("complete booking");
    ...
    public void onViewClicked() {
        ...
        InitLibrary.getInstance().completebooking(token,device,iduser,idbooking)
                    ...
                    public void onResponse(Call<ResponseDaftar> call, Response<ResponseDaftar> response) {
                        ...
                        if(response.isSuccessful()){
                            ...
                            if(result.equals("true")){
                                ...
                                startActivity(new Intent(DetailActiveActivity.this,BookingActivity.class));
                            }
                            else {
                                HeroHelper.pesan(DetailActiveActivity.this,pesan);
